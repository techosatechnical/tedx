        ...
        <div className="space-y-8 sm:space-y-10">
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="flex items-center p-3 sm:p-4 bg-gray-50 rounded-xl hover:bg-red-50 transition group">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">info@tedxthaltejyouth.in</p>
                </div>
              </div>
              ...
              <div className="flex items-center p-3 sm:p-4 bg-gray-50 rounded-xl hover:bg-red-50 transition group">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Thaltej, Ahmedabad, Gujarat</p>
                </div>
              </div>
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-xl">
            ...
            <div className="flex space-x-3 sm:space-x-4">
              ...
              {/* TED Icon */}
              <Link href="/" className="w-10 h-10 sm:w-12 sm:h-12 bg-red-600 rounded-xl flex items-center justify-center hover:bg-red-700 transition transform hover:scale-110 hover:rotate-3">
              ...
              {/* LinkedIn Icon */}
              <Link href="https://www.linkedin.com/company/tedxthaltej-youth/" className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-600 rounded-xl flex items-center justify-center hover:bg-blue-700 transition transform hover:scale-110 hover:rotate-3">
